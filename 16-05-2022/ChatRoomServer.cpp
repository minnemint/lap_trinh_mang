...
DWORD WINAPI ClientThread(LPVOID lpParam)
{
    ...
    while (1)
    {
        ...
        {
            FILE* f = fopen("C:\\Users\\Minh\\Documents\\TestServerUser.txt", "r");
            ...
            if (found == 1)
            {
                const char* msg = "Login thanh cong. Hay nhap lenh.\n";
            ...
            {
                const char* msg = "Khong tim thay tai khoan. Pls try again.\n";
